...
optim_name=$1
hparam_path=/home/bgebotys/projects/def-mjshafie/bgebotys/ngrad_rl/visualize/best_critic_runs.json

run () {
    env_name=$1
    python main.py --rgb_input False --async_env False --optim_name $optim_name \
        --num_steps 1000 --global_n_steps 5e6 \
        --async_env False --writer_path runs/5e6_best_critic/$env_name/ \
